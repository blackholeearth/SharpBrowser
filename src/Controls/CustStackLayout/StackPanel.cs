    ...
    public class StackLayout : Panel
    {
        ...
        private void PerformStackLayout_v4()
        {
            ...
            try
            {
                ...
                int expandingChildCount = 0;
                var weights = new Dictionary<Control,
                  int>();
                ...
                double fractionalSpace = 0.0;
                var calculatedExpanderSizes = new Dictionary<Control,
                  int>(); // Stores final calculated size for expanders
